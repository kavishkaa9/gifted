...
global.caption = "*©𝟐𝟎𝟐5 ⎯꯭̽ℤᴏᴏɴ   𝕃ɪᴠᴇ⎯꯭̽𝐎ꜰꜰɪᴄɪᴀ**"; // Input Yours custom...(Maintain font for Flow)
...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~r6pRgR4T#eS5_TR4m1ZTWfe2QHdAhmmoE-fcg90wp_g5cx-P8nmA", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "+94723278328", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "⎯꯭̽ℤᴏᴏɴ   𝕃ɪᴠᴇ⎯꯭̽𝐎ꜰꜰɪᴄɪᴀ*", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || ⎯꯭̽ℤᴏᴏɴ   𝕃ɪᴠᴇ⎯꯭̽𝐎ꜰꜰɪᴄɪᴀ*", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "⎯꯭̽ℤᴏᴏɴ   𝕃ɪᴠᴇ⎯꯭̽𝐎ꜰꜰɪᴄɪᴀ*", // Added // Input Yours custom...
PREFIX: process.env.PREFIX || ".",
API_KEY: process.env.API_KEY || "⎯꯭̽ℤᴏᴏɴ   𝕃ɪᴠᴇ⎯꯭̽𝐎ꜰꜰɪᴄɪᴀ*", // Replace with your unlimited api key
...
BOT_NAME: process.env.BOT_NAME || "⎯꯭̽ℤᴏᴏɴ   𝕃ɪᴠᴇ⎯꯭̽𝐎ꜰꜰɪᴄɪᴀ*", // Input Yours custom...(Maintain font for Flow)
...
TIME_ZONE: process.env.TIME_ZONE || "srilanka/colombo", // Enter yours else leave blank if not sure
};
